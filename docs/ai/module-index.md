...
| `@theorem/feature-academic` | `packages/features/academic` | `packages/features/academic/src/index.ts` | `@theorem/core`, `@theorem/ui` | Feature package. |
...
| `@theorem/web` | `apps/web` | `n/a` | `@theorem/core`, `@theorem/feature-academic`, `@theorem/feature-feeds`, `@theorem/feature-learning`, `@theorem/feature-library`, `@theorem/feature-reader`, `@theorem/feature-settings`, `@theorem/feature-statistics`, `@theorem/feature-vocabulary`, `@theorem/ui` | Application package. |
