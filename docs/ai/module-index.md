...
| `@theorem/web` | `apps/web` | `n/a` | `@theorem/core`, `@theorem/feature-feeds`, `@theorem/feature-library`, `@theorem/feature-reader`, `@theorem/feature-settings`, `@theorem/feature-statistics`, `@theorem/feature-vocabulary`, `@theorem/ui` | Application package. |
