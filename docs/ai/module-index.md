...
| `@theorem/feature-feeds` | `packages/features/feeds` | `packages/features/feeds/src/index.ts` | `@theorem/core`, `@theorem/feature-learning`, `@theorem/feature-reader`, `@theorem/ui` | Feature package. |
