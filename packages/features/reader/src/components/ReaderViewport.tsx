        ...
        <div className={cn('relative w-full h-full overflow-hidden', className)}>
            ...
            {displayError && !isLoading && (
                <div className="absolute inset-0 flex items-center justify-center bg-[var(--color-background)] z-30">
                    <div className="ui-empty-state-stack flex flex-col items-center gap-4 p-8 text-center">
                        ...
                        <h3 className="ui-empty-state-title text-lg font-semibold text-[color:var(--color-text-primary)]">
                            Failed to load book
                        </h3>
                        <p className="ui-empty-state-copy text-sm text-[color:var(--color-text-muted)] leading-relaxed">
                            {displayError}
                        </p>
                        <button
                            onClick={() => window.location.reload()}
                            className="ui-empty-state-action px-4 py-2 bg-[var(--color-accent)] ui-text-accent-contrast rounded-lg text-sm font-medium hover:opacity-90 transition-opacity"
                        >
                            Retry
                        </button>
                    </div>
