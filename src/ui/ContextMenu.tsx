            ...
            >
                {items.map((item, index) => {
                    if (item.separator) {
                        ...
                        if (!hasActionBefore || !hasActionAfter) return null;
                        return <div key={item.id} className="mx-3 my-1 h-px bg-[var(--color-border)]" />;
                    }
                    ...
                    return (
                        ...
                        >
                            ...
                            {item.shortcut && <span className="ml-auto text-[0.6875rem] text-[color:var(--color-text-muted)]">{item.shortcut}</span>}
                        </button>
                    );
                })}
            </div>
 ...
 * Triggers the shared global ContextMenuRoot
 */
