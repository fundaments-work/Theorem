...
export const APP_THEME_PALETTES: Record<ReaderTheme, ThemeSemanticPalette> = {
    light: {
        ...
        appSurfaceMuted: "#f5f5f5",
        appSurfaceVariant: "#f2f2f2",
        appSurfaceHover: "#ebebeb",
        appTextPrimary: "#111111",
        appTextSecondary: "#262626",
        appTextMuted: "#4a4a4a",
        ...
        appAccentLight: "#ededed",
        appAccentContrast: "#ffffff",
        appSuccess: "#111111",
        appWarning: "#2a2a2a",
        appError: "#000000",
        appInfo: "#333333",
        appOverlaySubtle: "color-mix(in srgb, #111111 10%, transparent)",
        appOverlayMedium: "color-mix(in srgb, #111111 22%, transparent)",
        appOverlayStrong: "color-mix(in srgb, #111111 55%, transparent)",
        appOverlayStrongHover: "color-mix(in srgb, #111111 70%, transparent)",
        readerBg: "#ffffff",
        readerFg: "#111111",
        readerLink: "#111111",
    },
    sepia: {
        ...
        appSurface: "#f8f8f8",
        appSurfaceElevated: "#ffffff",
        appSurfaceMuted: "#ececec",
        appSurfaceVariant: "#e7e7e7",
        appSurfaceHover: "#dfdfdf",
        appTextPrimary: "#141414",
        appTextSecondary: "#2e2e2e",
        appTextMuted: "#535353",
        appTextInverse: "#f8f8f8",
        appBorder: "#c8c8c8",
        appBorderSubtle: "#dfdfdf",
        appAccent: "#111111",
        appAccentHover: "#000000",
        appAccentLight: "#e5e5e5",
        appAccentContrast: "#ffffff",
        appSuccess: "#1a1a1a",
        appWarning: "#303030",
        appError: "#000000",
        appInfo: "#3d3d3d",
        appOverlaySubtle: "color-mix(in srgb, #141414 10%, transparent)",
        appOverlayMedium: "color-mix(in srgb, #141414 22%, transparent)",
        appOverlayStrong: "color-mix(in srgb, #141414 55%, transparent)",
        appOverlayStrongHover: "color-mix(in srgb, #141414 70%, transparent)",
        readerBg: "#f2f2f2",
        readerFg: "#111111",
        readerLink: "#111111",
    },
    dark: {
        appBg: "#0b0b0b",
        appSurface: "#121212",
        appSurfaceElevated: "#191919",
        appSurfaceMuted: "#1e1e1e",
        appSurfaceVariant: "#242424",
        appSurfaceHover: "#2d2d2d",
        appTextPrimary: "#f5f5f5",
        appTextSecondary: "#e0e0e0",
        appTextMuted: "#c2c2c2",
        appTextInverse: "#0b0b0b",
        appBorder: "#424242",
        appBorderSubtle: "#2c2c2c",
        appAccent: "#ffffff",
        appAccentHover: "#f0f0f0",
        appAccentLight: "#2a2a2a",
        appAccentContrast: "#111111",
        appSuccess: "#f5f5f5",
        appWarning: "#d9d9d9",
        appError: "#ffffff",
        appInfo: "#cccccc",
        appOverlaySubtle: "color-mix(in srgb, #f5f5f5 10%, transparent)",
        appOverlayMedium: "color-mix(in srgb, #f5f5f5 22%, transparent)",
        appOverlayStrong: "color-mix(in srgb, #f5f5f5 55%, transparent)",
        appOverlayStrongHover: "color-mix(in srgb, #f5f5f5 70%, transparent)",
        readerBg: "#101010",
        readerFg: "#f5f5f5",
        readerLink: "#ffffff",
    },
...
export const HIGHLIGHT_COLOR_TOKENS: Record<HighlightColor, HighlightColorToken> = {
    ...
    green: {
        label: "Graphite",
        solid: "#2b2b2b",
        soft: "rgba(43, 43, 43, 0.24)",
        softDark: "rgba(224, 224, 224, 0.18)",
        picker: "#c4c4c4",
        pickerActive: "#ababab",
    },
    blue: {
        label: "Slate",
        solid: "#454545",
        soft: "rgba(69, 69, 69, 0.22)",
        softDark: "rgba(194, 194, 194, 0.16)",
        picker: "#b3b3b3",
        pickerActive: "#999999",
    },
    red: {
        label: "Smoke",
        solid: "#5f5f5f",
        soft: "rgba(95, 95, 95, 0.2)",
        softDark: "rgba(160, 160, 160, 0.14)",
        picker: "#9c9c9c",
        pickerActive: "#878787",
    },
    orange: {
        label: "Mist",
        solid: "#7a7a7a",
        soft: "rgba(122, 122, 122, 0.18)",
        softDark: "rgba(130, 130, 130, 0.12)",
        picker: "#858585",
        pickerActive: "#727272",
    },
    purple: {
        label: "Ash",
        solid: "#949494",
        soft: "rgba(148, 148, 148, 0.16)",
        softDark: "rgba(102, 102, 102, 0.1)",
        picker: "#707070",
        pickerActive: "#5c5c5c",
    },
};
...
export const READER_THEME_PREVIEWS: Record<ReaderTheme, { bg: string; fg: string }> = {
    ...
    sepia: { bg: "#f2f2f2", fg: "#111111" },
    dark: { bg: "#101010", fg: "#f5f5f5" },
};
