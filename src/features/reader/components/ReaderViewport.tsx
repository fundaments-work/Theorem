                ...
                <div className="absolute inset-0 flex items-center justify-center bg-[var(--color-background)] z-30">
                    <div className="mx-auto w-full max-w-[26rem] min-w-0 flex flex-col items-center gap-4 p-8 text-center">
                        ...
                        <button
                            ...
                            className="min-w-[10.5rem] whitespace-nowrap px-4 py-2 bg-[var(--color-accent)] text-[color:var(--color-accent-contrast)] rounded-lg text-sm font-medium hover:opacity-90 transition-opacity"
                        >
                            Retry
                        </button>
                    </div>
