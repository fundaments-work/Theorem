...
use image::{DynamicImage, ImageEncoder, ImageFormat, codecs::png::PngEncoder, codecs::jpeg::JpegEncoder};
use std::io::Cursor;
...
mod tests {
    ...
    fn test_jpeg_quality_levels() {
        ...
        assert!(low.size_bytes <= medium.size_bytes || medium.size_bytes <= high.size_bytes,
